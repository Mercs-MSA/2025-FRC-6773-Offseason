...
public class Drive extends SubsystemBase{
    ...
    public Drive(Module[] modules, GyroIO gyro, Vision vision, Elevator elevator) {
    ...
    */
    ...
    public void periodic() {
        ...
        // if (getPoseEstimate().getX() < 7.5) {
        //     GoalPoseChooser.setSide(SIDE.RIGHT);
        // } else {
        //     GoalPoseChooser.setSide(SIDE.LEFT);
        // }
    ...
    public void setDriveState(DriveState state) {
        ...
        switch(driveState) {
            case DRIVE_TO_CORAL:
                ...
                // goalPose = new Pose2d(0, 0, new Rotation2d());
                // if (getPoseEstimate().getX() < 8.75) {
                //     goalPose.plus(new Transform2d(-8.75, 0.0, new Rotation2d()));
                // }
                break;
            case DRIVE_TO_INTAKE:
                autoAlignController.reset(
