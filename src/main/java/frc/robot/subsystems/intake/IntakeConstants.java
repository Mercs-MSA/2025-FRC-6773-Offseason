...
//     16); // Totral region of interest height
  ...
  public static final IntakePivotTalonFXConfiguration kPivotMotorConfiguration = new IntakePivotTalonFXConfiguration(
    ...
    public static final IntakeRollerTalonFXConfiguration kRollerMotorConfiguration = new IntakeRollerTalonFXConfiguration(
      true, // Invert
      true, // Enable stator current limiting
      true, // Enable supply current limiting
      60.0, // Stator limit
  ...
  public static final IntakePivotSimulationConfiguration kPivotSimulationConfiguration = new IntakePivotSimulationConfiguration(
