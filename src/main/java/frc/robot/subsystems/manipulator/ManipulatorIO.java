...
public interface ManipulatorIO {
  ...
  public static class ManipulatorIOInputs {
    ...
    public double flywheelVelocityRotPerSec;

    public double flywheelAppliedVolts;

    public double flywheelSupplyCurrentAmps;

    public double flywheelTemperatureCelsius;

    public double flywheelStatorCurrentAmps;
  }
